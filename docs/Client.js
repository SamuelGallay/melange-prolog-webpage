(() => {
  ...
  var require_Prolog_bs = __commonJS((exports) => {
    ...
    function string_of_term(t) {
      ...
      if (variant === "GeneralVar" || variant === "TableVar") {
        return t.VAL._0;
      }
      var match = t.VAL;
      var s = match[0];
      if (match[1]) {
        return s + ("(" + ($$String.concat(", ", Curry._2(CompatibilityCrap.List.map, string_of_term, match[1])) + ")"));
      } else {
        return s;
      }
    }
    ...
    function string_of_clause(param) {
      var tl = param._1;
      return string_of_term(param._0) + ((Caml_obj.caml_equal(tl, 0) ? "" : " :- ") + ($$String.concat(", ", Curry._2(CompatibilityCrap.List.map, string_of_term, tl)) + "."));
    }
    function _string_of_program(cl) {
      return $$String.concat("\n", Curry._2(CompatibilityCrap.List.map, string_of_clause, cl));
    }
    function remove_spaces(_param) {
      while (true) {
        var param = _param;
        if (!param) {
          return 0;
    ...
    function $plus$tilde(p, q, cl) {
      return CompatibilityCrap.$at(Curry._1(p, cl), Curry._1(q, cl));
    }
    function $star$tilde(p, q, cl) {
      return Curry._1(CompatibilityCrap.List.concat, Curry._2(CompatibilityCrap.List.map, function(param) {
        var a = param[1];
        return Curry._2(CompatibilityCrap.List.map, function(param2) {
          return [
            param2[0],
            [
              a,
    ...
    function $star$great$tilde(p, f, cl) {
      return Curry._2(CompatibilityCrap.List.map, function(param) {
        return [
          param[0],
          Curry._1(f, param[1])
        ];
    ...
    function null_parser(_cl) {
      return 0;
    }
    function epsilon_parser(cl) {
      return {
        hd: [
          cl,
          void 0
    ...
    function any(pl) {
      return Curry._3(CompatibilityCrap.List.fold_left, $plus$tilde, null_parser, pl);
    }
    var lower_case = "abcdefghijklmnopqrstuvwxyz";
    var upper_case = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
    var other_chars = "0123456789_-";
    var all_chars = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_-";
    function parse_char_of(s) {
      return any(Curry._2(CompatibilityCrap.List.map, parse_char, charlist_of_string(s)));
    }
    function parse_word(cl) {
      var partial_arg2 = parse_char_of(all_chars);
      var partial_arg$12 = function(param) {
        return $star$tilde(partial_arg2, parse_word, param);
      };
      return $plus$tilde(parse_char_of(all_chars), function(param) {
        return $star$great$tilde(partial_arg$12, function(param2) {
          return param2[0] + param2[1];
        }, param);
      }, cl);
    }
    var partial_arg = parse_char_of(lower_case);
    function partial_arg$1(param) {
      return $star$tilde(partial_arg, parse_word, param);
    }
    function partial_arg$2(param) {
      return $star$great$tilde(partial_arg$1, function(param2) {
        return param2[0] + param2[1];
      }, param);
    }
    var partial_arg$3 = parse_char_of(lower_case);
    function parse_predicate_string(param) {
      return $plus$tilde(partial_arg$3, partial_arg$2, param);
    }
    var partial_arg$4 = parse_char_of(upper_case);
    function partial_arg$5(param) {
      return $star$tilde(partial_arg$4, parse_word, param);
    }
    function partial_arg$6(param) {
      return $star$great$tilde(partial_arg$5, function(param2) {
        return param2[0] + param2[1];
      }, param);
    }
    var partial_arg$7 = parse_char_of(upper_case);
    function parse_variable_string(param) {
      return $plus$tilde(partial_arg$7, partial_arg$6, param);
    }
    ...
    function parse_generalvar(param) {
      return $plus$tilde(function(param2) {
        return $star$great$tilde(function(param3) {
          return parse_char(95, param3);
        }, function(param3) {
          return {
            NAME: "GeneralVar",
            VAL: new_id(void 0)
        ...
        return $star$great$tilde(parse_variable_string, function(s) {
          return {
            NAME: "GeneralVar",
            VAL: {
              _0: s,
    ...
    function parenthesis(p) {
      return function(param) {
        return $star$great$tilde(function(param2) {
          return $star$tilde(function(param3) {
            return $star$tilde(function(param4) {
              return parse_char(40, param4);
            }, p, param3);
          }, function(param3) {
            return parse_char(41, param3);
          }, param2);
        }, function(param2) {
          return param2[0][1];
        }, param);
    ...
    function bracket(p) {
      return function(param) {
        return $star$great$tilde(function(param2) {
          return $star$tilde(function(param3) {
            return $star$tilde(function(param4) {
              return parse_char(91, param4);
            }, p, param3);
          }, function(param3) {
            return parse_char(93, param3);
          }, param2);
        }, function(param2) {
          return param2[0][1];
        }, param);
    ...
    function parse_term(cl) {
      return $plus$tilde(function(param) {
        return $plus$tilde(parse_generalvar, parse_predicate, param);
      }, term_parsetable, cl);
    }
    function parse_predicate(cl) {
      var partial_arg2 = parenthesis(parse_termlist);
      var partial_arg$12 = function(param) {
        return $star$tilde(parse_predicate_string, partial_arg2, param);
      };
      return $plus$tilde(function(param) {
        return $star$great$tilde(partial_arg$12, function(param2) {
          return {
        ...
        return $star$great$tilde(parse_predicate_string, function(name) {
          return {
            NAME: "Predicate",
            VAL: [
              name,
    ...
    function parse_table(cl) {
      var partial_arg2 = bracket(function(param) {
        return $star$tilde(function(param2) {
          return $star$tilde(parse_termlist, function(param3) {
            return parse_char(124, param3);
          }, param2);
        }, parse_table, param);
      });
      var partial_arg$12 = function(param) {
        return $star$great$tilde(partial_arg2, function(param2) {
          return table_of_termlist(param2[1], param2[0][0]);
        }, param);
      };
      var partial_arg$22 = bracket(parse_termlist);
      var partial_arg$32 = function(param) {
        return $star$great$tilde(partial_arg$22, function(tl) {
          return table_of_termlist("EmptyTable", tl);
        }, param);
      };
      var partial_arg$42 = bracket(epsilon_parser);
      var partial_arg$52 = function(param) {
        return $star$great$tilde(partial_arg$42, function(param2) {
          return "EmptyTable";
        }, param);
      };
      var partial_arg$62 = function(param) {
        return $plus$tilde(partial_arg$52, partial_arg$32, param);
      };
      var partial_arg$72 = bracket(function(param) {
        return $star$tilde(function(param2) {
          return $star$tilde(parse_termlist, function(param3) {
            return parse_char(124, param3);
          }, param2);
        }, parse_variable_string, param);
      });
      return $plus$tilde(function(param) {
        return $plus$tilde(partial_arg$62, partial_arg$12, param);
      }, function(param) {
        return $star$great$tilde(partial_arg$72, function(param2) {
          return table_of_termlist({
            NAME: "TableVar",
            VAL: {
              _0: param2[1],
              _1: 0
    ...
    function parse_termlist(cl) {
      return $plus$tilde(function(param) {
        return $star$great$tilde(parse_term, function(t) {
          return {
            hd: t,
            tl: 0
          };
        ...
        return $star$great$tilde(function(param2) {
          return $star$tilde(function(param3) {
            return $star$tilde(parse_term, function(param4) {
              return parse_char(44, param4);
            }, param3);
          }, parse_termlist, param2);
        }, function(param2) {
          return {
            hd: param2[0][0],
            tl: param2[1]
    ...
    function parse_clause(param) {
      return $plus$tilde(function(param2) {
        return $star$great$tilde(function(param3) {
          return $star$tilde(parse_term, function(param4) {
            return parse_char(46, param4);
          }, param3);
        }, function(param3) {
          return {
            _0: param3[0],
        ...
        return $star$great$tilde(function(param3) {
          return $star$tilde(function(param4) {
            return $star$tilde(function(param5) {
              return $star$tilde(function(param6) {
                return $star$tilde(parse_term, function(param7) {
                  return parse_char(58, param7);
                }, param6);
              }, function(param6) {
                return parse_char(45, param6);
              }, param5);
            }, parse_termlist, param4);
          }, function(param4) {
            return parse_char(46, param4);
          }, param3);
        }, function(param3) {
    ...
    function parse_program(cl) {
      return $plus$tilde(function(param) {
        return $star$great$tilde(parse_clause, function(c) {
          return {
            hd: c,
            tl: 0
          };
    ...
    function parse_request(param) {
      return $star$great$tilde(function(param2) {
        return $star$tilde(parse_termlist, function(param3) {
          return parse_char(63, param3);
        }, param2);
      }, function(param2) {
        return param2[0];
      }, param);
    }
    function unambiguous_parser_of(parser, s) {
      var results = Curry._2(CompatibilityCrap.List.filter, function(param) {
        return Caml_obj.caml_equal(param[0], 0);
      }, Curry._1(parser, remove_spaces(charlist_of_string(s))));
      if (results) {
        if (results.tl) {
          return {
            TAG: 1,
            _0: "Parsing failed, my grammar in ambiguous !"
          };
        } else {
          return {
            TAG: 0,
        ...
        return {
          TAG: 1,
          _0: "Parsing failed, I don't understand what you're saying !"
        };
      }
    }
    function _term_of_string(param) {
      return unambiguous_parser_of(parse_term, param);
    }
    ...
    function to_seq(str) {
      if (str.TAG === 0) {
        var partial_arg2 = str._0;
        return function(param) {
          return CompatibilityCrap.Seq.$$return(partial_arg2, param);
        };
      }
      var partial_arg$12 = list_to_seq(str._0);
      return function(param) {
    ...
    function program_of_string(s) {
      return CompatibilityCrap.Result.map(type_inference_program, unambiguous_parser_of(parse_program, s));
    }
    function request_of_string(s) {
      return CompatibilityCrap.Result.map(type_inference_request, unambiguous_parser_of(parse_request, s));
    }
    ...
    exports._string_of_program = _string_of_program;
    exports.remove_spaces = remove_spaces;
    exports.charlist_of_string = charlist_of_string;
    exports.parse_char = parse_char;
    exports.$plus$tilde = $plus$tilde;
    exports.$star$tilde = $star$tilde;
    exports.$star$great$tilde = $star$great$tilde;
    exports.null_parser = null_parser;
    exports.epsilon_parser = epsilon_parser;
    exports.any = any;
    exports.lower_case = lower_case;
    exports.upper_case = upper_case;
    exports.other_chars = other_chars;
    exports.all_chars = all_chars;
    exports.parse_char_of = parse_char_of;
    exports.parse_word = parse_word;
    exports.parse_predicate_string = parse_predicate_string;
    exports.parse_variable_string = parse_variable_string;
    exports.counter_unnamed_ids = counter_unnamed_ids;
    exports.new_id = new_id;
    exports.parse_generalvar = parse_generalvar;
    exports.table_of_termlist = table_of_termlist;
    exports.parenthesis = parenthesis;
    exports.bracket = bracket;
    exports.parse_term = parse_term;
    exports.parse_predicate = parse_predicate;
    exports.parse_table = parse_table;
    exports.term_parsetable = term_parsetable;
    exports.parse_termlist = parse_termlist;
    exports.parse_clause = parse_clause;
    exports.parse_program = parse_program;
    exports.parse_request = parse_request;
    exports.unambiguous_parser_of = unambiguous_parser_of;
    exports._term_of_string = _term_of_string;
